    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('filename_full') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $photo->has('player') ? $this->Html->link($photo->player->id, ['controller' => 'Players', 'action' => 'view', $photo->player->id]) : '' ?></td>
                <td><?= h($photo->filename_full) ?></td>
                <td><?= h($photo->filename) ?></td>
                <td><?= h($photo->extension) ?></td>
